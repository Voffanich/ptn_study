...
finish_row_f = {'Код':'','Товар':'','Количество':'','Цена':'Итого','Стоимость':'=СУММ(E2:E' + str(table_f.shape[0]+1) +')'}          # Добавление строки с итоговой стоимостью в таблицу со значениями
